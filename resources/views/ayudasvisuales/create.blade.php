...
<div style="width: 75%; margin-left: 12.5%; margin-right: 12.5%;">
	<h1>Subir Ayuda visual</h1>
	{!! Form::open(['url'=>'/ayudasvisuales','enctype'=>'multipart/form-data']) !!}
	<div class="row">
		<div class="col-md-4">
			...
			<div class="input-group mb-3">
				...
				<input name="nombre" class="form-control" value="{!! old('nombre') !!}" placeholder="Nombre de la ayuda visual" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		...
		<div class="col-md-4">
			...
			<div class="input-group mb-3">
				...
				<input name="pieza" class="form-control" value="{!! old('pieza') !!}" placeholder="Nombre de la pieza" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		...
		<div class="col-md-4">
			...
			<div class="input-group mb-3">
				...
				<input name="documento" id="documento" type="file" accept=".pdf" class="form-control" value="{!! old('documento') !!}" placeholder="Documento" aria-label="Username" aria-describedby="basic-addon1" onchange="previewDocument();">
			</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="input-group mb-3">
				...
				<input name="fecha_creacion" type="date" class="form-control" value="{!! old('fecha_creacion') !!}" placeholder="Fecha de creación" aria-label="Username" aria-describedby="basic-addon1">
			</div>
	...
	{!! Form::submit('Subir ayuda visual', ['class'=>'btn btn-success', 'style'=>'margin: auto; position: absolute; right: 15%;']) !!}
	{!! Form::close() !!}
</div>
<br/>
<br/>
