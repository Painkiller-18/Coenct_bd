...
<div style="width: 75%; margin-left: 12.5%; margin-right: 12.5%;">
	<h1>Editar Kaizen</h1>
	{!! Form::open([ 'method' => 'PATCH' , 'url' =>'/kaizen/'.$kaizen->id, 'enctype'=>'multipart/form-data']) !!}
	<div class="row">
		<div class="col-md-4">
			...
			<div class="input-group mb-3">
				...
				<input name="nombre" class="form-control" value="{!! old('nombre', $kaizen->nombre) !!}" placeholder="Nombre de kaizen" aria-label="nombre" aria-describedby="basic-addon1">
			</div>
		...
		<div class="col-md-6">
			...
			<div class="input-group mb-3">
				...
				<input id="documento" class="form-control" type="file" accept=".pdf" name="documento" value="{{old('documento', $kaizen->documento)}}" onchange="previewDocument();">
			</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="input-group mb-3">
				...
				<input id="fecha_creacion" class="form-control" type="date"  readonly value="{{old('fecha_creacion', $kaizen->fecha_creacion)}}">
			</div>
	...
	<div style="width: 100%; display: flex; align-items: center; justify-content: center;">
		<iframe id="preview" src="{{ asset('/storage/public/kaizen/'.$kaizen->documento.'') }}" frameborder="0" width="75%" height="800px"></iframe>
	</div>
	<br />
</div>
@endsection()
