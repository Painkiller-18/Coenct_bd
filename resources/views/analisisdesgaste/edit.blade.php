...
<div style="width: 75%; margin-left: 12.5%; margin-right: 12.5%;">
	<h1>Editar Análisis De Desgaste</h1>
	{!! Form::open([ 'method' => 'PATCH' , 'url' =>'/analisisdesgaste/'.$analisisdesgaste->id, 'enctype'=>'multipart/form-data']) !!}
	<div class="row">
		<div class="col-md-4">
			<label for="nombre">Nombre del análisis:</label>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text fa fa-file"></span>
				</div>
				<input name="nombre" class="form-control" value="{!! old('nombre', $analisisdesgaste->nombre) !!}" placeholder="Nombre de analisisdesgaste" aria-label="nombre" aria-describedby="basic-addon1">
			</div>
		...
		<div class="col-md-6">
			...
			<div class="input-group mb-3">
				...
				<input id="documento" class="form-control" type="file" accept=".pdf" name="documento" value="{{old('documento', $analisisdesgaste->documento)}}" onchange="previewDocument();">
			</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="input-group mb-3">
				...
				<input id="fecha_creacion" class="form-control" type="date" readonly value="{{old('fecha_creacion', $analisisdesgaste->fecha_creacion)}}">
			</div>
	...
	<div style="width: 100%; display: flex; align-items: center; justify-content: center;">
		<iframe id="preview" src="{{ asset('/storage/public/analisisdesgaste/'.$analisisdesgaste->documento.'') }}" frameborder="0" width="75%" height="800px"></iframe>
	</div>
	<br />
</div>
@endsection()
