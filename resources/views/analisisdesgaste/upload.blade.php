...
<div style="width: 75%; margin-left: 12.5%; margin-right: 12.5%;">
	<h1>Subir Análsis de Desgaste</h1>
	{!! Form::open([ 'method' => 'PUT' , 'url' =>'/analisisdesgaste/upload', 'enctype'=>'multipart/form-data']) !!}
	<div class="row">
		<div class="col-md-4">
			...
			<div class="input-group mb-3">
				...
				<input name="nombre" class="form-control" value="{!! old('nombre') !!}" placeholder="Nombre de analisisdesgaste" aria-label="nombre" aria-describedby="basic-addon1">
			</div>
